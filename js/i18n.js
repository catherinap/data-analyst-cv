...
const translations = {
  ...
  "resume.skills.kicker": { en: "Skills", da: "Kompetencer" },
  "resume.skills.title": { en: "What I work with", da: "Hvad jeg arbejder med" },
  ...
  "resume.skills.prog.kicker": { en: "Programming & Tools", da: "Programmering & Værktøjer" },
  "resume.skills.prod.kicker": { en: "Productivity & Documentation", da: "Produktivitet & Dokumentation" },
  "resume.skills.other.kicker": { en: "Other Skills", da: "Andre Kompetencer" },
  "resume.skills.other.chip1": { en: "Adaptability", da: "Tilpasningsevne" },
  "resume.skills.other.chip2": { en: "Detail-oriented", da: "Detaljeorienteret" },
  "resume.skills.other.chip3": { en: "Time-management", da: "Tidsstyring" },
  "resume.skills.other.chip4": { en: "Cross-cultural communication", da: "Tværkulturel kommunikation" },
  "resume.skills.other.chip5": { en: "Driving license B", da: "Kørekort B" },
  ...
  "resume.edu.item0.status": { en: "In progress / planned — pending job center approval", da: "I gang / planlagt — afventer godkendelse fra jobcenter" },
  "resume.edu.item0.text": { en: "Python, statistics, SQL, Excel, Tableau.", da: "Python, statistik, SQL, Excel, Tableau." },
  "resume.edu.item4.title": { en: "Environment Design", da: "Miljødesign" },

  "resume.lang.kicker": { en: "Languages", da: "Sprog" },
  "resume.lang.title": { en: "Languages", da: "Sprog" },
  "resume.lang.uk": { en: "Ukrainian — Native", da: "Ukrainsk — Modersmål" },
  "resume.lang.ru": { en: "Russian — Fluent", da: "Russisk — Flydende" },
  "resume.lang.en": { en: "English — B2", da: "Engelsk — B2" },
  "resume.lang.pl": { en: "Polish — B1", da: "Polsk — B1" },
  "resume.lang.de": { en: "German — A2", da: "Tysk — A2" },
  "resume.lang.da": { en: "Danish — Beginner", da: "Dansk — Begynder" },
};
