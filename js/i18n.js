...
const translations = {
  ...
  "resume.summary": {
    en: "Digital generalist moving into data analytics, with a background in frontend development, digital design, and self-built financial data tools. Currently completing a Data Analytics Specialist program (Python, SQL, Excel, Tableau) to formalize practical, hands-on experience gained by building COT/market data pipelines, Excel reporting systems, and dashboards. Adaptable, detail-oriented, and structured in how I work - currently based in Denmark and actively learning Danish from scratch.",
