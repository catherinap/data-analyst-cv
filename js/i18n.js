...
const translations = {
  ...
  "resume.summary": {
    en: "Digital generalist moving into data analytics, with a background in frontend development, digital design, and self-built financial data tools.Currently completing a Relational Databases Certification, working With SQL to formalize practical, hands- on experience gained by building COT/ market data pipeline, Excel reporting system, and dashboard.Adaptable, detail-oriented, and structured in how I work - currently based in Denmark and actively learning Danish from scratch.",
    da: "Digital generalist, der bevæger sig ind i dataanalyse, med en baggrund i frontend-udvikling, digitalt design og selvbyggede finansielle dataværktøjer. Jeg er i øjeblikket i gang med en certificering i relationelle databaser og arbejder med SQL for at formalisere praktisk erfaring opnået ved at bygge COT/markedsdatapipeline, Excel-rapporteringssystem og dashboard. Jeg er tilpasningsdygtig, detaljeorienteret og struktureret i min arbejdsmetoder - i øjeblikket baseret i Danmark og lærer aktivt dansk fra bunden.",
  },
